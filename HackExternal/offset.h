...
#define GameVars BloodHunt::Variables::Get()
	...
	public:
		...
		DWORD offset_u_world = 0x6763160;//.text:00007FF6523B2E02	sub_7FF6523B26B0	mov     rbx, cs : 7FF658411CE0h // 0x7026B0 or // 0x23B26B0 // 676 1CE0
		DWORD offset_g_names = 0x65F36C0;//.text:00007FF6540BE386	sub_7FF6540BE2E0	db  48h; H		  7FF651CB0000 // 0x240E2E0 7FF6582A2240
		DWORD offset_g_obj = 0x660AA90;//.48 8B 05 ?? ?? ?? ?? 48 8B 14 C8 49 63 C0 48 8D 0C 40 48 39 34 CA .text:00007FF6525547D8	sub_7FF652554750	mov     rax, cs:7FF6582BAA90h
		//Camera
		...
		DWORD offset_Shield = 0x1100; // APlayerState char bIsABot : 1; // 0x232(0x01)
		DWORD offset_ShieldMax = 0x10f4; // APlayerState char bIsABot : 1; // 0x232(0x01)
		DWORD offset_ShieldLevel = 0x1108; // APlayerState char bIsABot : 1; // 0x232(0x01)
		DWORD offset_player_name = 0x310; // APlayerState 	PlayerNamePrivate 	0x300 	FString
		DWORD offset_ESCMPlayerTypeisBOT = 0x0A9A; // APlayerState char bIsABot : 1; // 0x232(0x01)
		DWORD offset_ASolarTeamInfotTeam = 0x0A68; // APlayerState char bIsABot : 1; // 0x232(0x01)
